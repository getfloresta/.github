...
Foresta is a collection of tools for developing Bitcoin clients that offers better privacy and sovereignty. You can find all our links and blog posts on the [website](https://getfloresta.org).

Detailed documentation for `libfloresta` is available [here](https://docs.getfloresta.sh/floresta). Additionally, the [`floresta-docs`](https://getfloresta.github.io/floresta-docs/) mdBook provides an in-depth look at the libraries' architecture and internals. Further information can be found in the [doc folder](https://github.com/getfloresta/Floresta/tree/master/doc).
...
|---------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|-----------------------------------------------------|----------------------|
| [`floresta`](https://github.com/getfloresta/floresta)                     | Floresta's monorepo. Here you can find all the libraries that make up Floresta, as well as the binaries. | [Davidson Souza](https://github.com/Davidson-Souza) | [Chris G.](https://github.com/csgui) |
